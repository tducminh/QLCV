...
exports.userSchema = typebox_1.Type.Object({
    ...
    PhongId: typebox_1.Type.Number(),
    DonviId: typebox_1.Type.Number(),
...
exports.userDataSchema = typebox_1.Type.Pick(exports.userSchema, ['email', 'password', 'Ma', 'Ten', 'level', 'PhongId', 'DonviId', 'createdAt'], {
    $id: 'UserData'
});
...
exports.userQueryProperties = typebox_1.Type.Pick(exports.userSchema, ['id', 'Ma', 'Ten', 'email', 'level', 'PhongId', 'DonviId', 'createdAt'], {});
